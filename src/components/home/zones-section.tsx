        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <FadeIn className="lg:w-2/5 shrink-0" direction="left">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-navy leading-tight mb-5">
              El Caribe Mexicano, tu nuevo hogar
            </h2>
            <p className="text-muted-foreground text-base leading-relaxed mb-8">
              Tulum, Playa del Carmen, Akumal, Cobá. Cada zona tiene su propio perfil de mercado,
              su propio tipo de comprador y su propio potencial de inversión. Llevamos 12 años
              conociendo cada una a fondo.
            </p>
            <Link
              href="/propiedades"
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="absolute bottom-4 left-4">
                  ...
                  <p className="text-white/70 text-sm">{zones[0].count} propiedades</p>
                </div>
              </Link>
              ...
              {zones.slice(1).map((zone) => (
                ...
                >
                  ...
                  <div className="absolute bottom-3 left-3">
                    ...
                    <p className="text-white/65 text-xs">{zone.count} propiedades</p>
                  </div>
                </Link>
              ))}
            </div>
